...
EXP_NAME="qwen3gen-${DATASET}-${METHOD_UPPER}-${MODEL_NAME_FOR_EXP}-mbs${MINI_BATCH_SIZE}${DECAY_SUFFIX}-train${TRAIN_BATCH_SIZE}-rollout${ROLLOUT_BATCH_SIZE}-lr${LR}-vllm${VLLM_GPU_MEMORY_UTILIZATION}"
